    ...
    <footer className="border-t-2 border-ink bg-bone">
      <div className="mx-auto grid max-w-7xl gap-10 px-6 py-14 md:grid-cols-3">
        <div>
          ...
          <p className="mt-4 max-w-xs text-sm leading-relaxed text-ink">
            Buy a meal, give a meal. Hot soup from a volunteer-run cart in
            downtown Calgary that turns paid lunches into free meals for
            neighbours.
          </p>
        </div>
        <div>
      ...
      <div className="border-t border-ink/15">
        <div className="mx-auto max-w-7xl px-6 py-5 text-xs tracking-wide text-fog">
          ...
          &middot; &copy; {new Date().getFullYear()} Huggabowl
        </div>
      </div>
    </footer>
  );
